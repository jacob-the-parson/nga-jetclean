...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize non-scroll dependent features immediately
    initializeImmediateFeatures();
    
    // Wait for complete page load before initializing scroll-dependent features
    if (document.readyState === 'complete') {
...
// Initialize all scroll-dependent features
function initializeScrollFeatures() {
    ...
    window.addEventListener('scroll', function() {
        ...
        // Add 'scrolled' class for CTA button animation
        ...
        updateActiveMenuOnScroll(scrollPosition);
    });
}

// Helper function to update active menu item
function updateActiveMenuOnScroll(scrollPosition) {
